...
INTEGER, INTENT(IN OUT)                  :: nr
REAL, INTENT(OUT)            :: k
REAL, INTENT(IN OUT)         :: tact



IF(ABS(tact) < petit)THEN
  CALL wk1(nr,k)
ELSE
  k = LOG(k)
...
REAL, INTENT(IN OUT)         :: b3
REAL, INTENT(IN OUT)         :: b4
REAL, INTENT(IN OUT)         :: b5
REAL, INTENT(IN OUT)         :: b6
REAL, INTENT(IN OUT)         :: b7
...
REAL, INTENT(IN OUT)         :: b6
REAL, INTENT(IN OUT)         :: b7
REAL, INTENT(IN OUT)         :: b8
REAL, INTENT(IN OUT)         :: b9
REAL, INTENT(IN OUT)         :: b10
...
REAL, INTENT(IN)             :: b(ntabphotmax)
REAL, INTENT(IN)             :: tabphot(ntabphotmax)
INTEGER, INTENT(IN OUT)                  :: it
INTEGER :: i,j
REAL :: a(ntabphotmax), c(4,nintphotmax)
...
REAL, INTENT(IN OUT)         :: s(nespmax,nrmax)
INTEGER, INTENT(IN OUT)                  :: nr
...
REAL, INTENT(IN)             :: a(ntabphotmax)
REAL, INTENT(IN)             :: b(ntabphotmax)
REAL, INTENT(OUT)            :: c(4,nintphotmax)
INTEGER :: i, n0

REAL :: d(ntabphotmax)
REAL :: c20(nintphotmax),c21(nintphotmax)
REAL :: c30(nintphotmax)
REAL :: c31(nintphotmax),c40(nintphotmax)
REAL :: c41(nintphotmax),cc31
